...
async function insertAccount(account) {
    ...
    account = {                                             //deixar o id na parte de cima na impressao
        id: data.nextId++,
        name: account.name,
    ...
    await writeFile(global.fileName, JSON.stringify(data, null, 2));  //o campus null e 2 serve para organizado (formatado) no accounts.json
